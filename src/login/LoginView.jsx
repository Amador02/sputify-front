    ...
    return (
        <div className='relative overflow-hidden'>
            <div className='w-full h-[100vh] flex flex-col items-center p-4 gap-4'>
                ...
                <label className='text-[2.25rem] font-semibold'>Inicio de Sesión</label>
                <div className="relative flex w-96 flex-col rounded-xl bg-[#fff] bg-clip-border text-gray-700 shadow-md p-2">
                    ...
                    >
                        ¿No tienes cuenta?
                        <NavLink to='/signup' className='ml-1 block font-sans text-sm font-bold leading-normal text-cyan-500 antialiased'>
                            Crear Cuenta
                        </NavLink>
                    </p>
