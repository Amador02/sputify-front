...
*/
const musicCard = ({ key, cancion, setActiveSong, activeSong }) => {
    return (
        <div key={key} className='max-h-fit min-h-fit h-fit w-fit min-w-fit max-w-fit flex flex-col overflow-clip '>
            ...
            <NavLink to={`/songs/${cancion.songid}`}>
                <label className='max-w-min whitespace-nowrap text-nowrap cursor-pointer font-semibold hover:font-extrabold'>{cancion.song}</label>
            </NavLink>
            <NavLink to={`/artists/${cancion.authorid}`}>
                <label className='max-w-min whitespace-nowrap text-nowrap cursor-pointer font-normal hover:font-bold'>{cancion.author}</label>
            </NavLink>
        </div>
